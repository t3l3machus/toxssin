...
This project started as (and still is) a research-based creative endeavor to explore the exploitability depth that an XSS vulnerability may present, using trusted certificates, vanilla JavaScript and cheap tricks.
